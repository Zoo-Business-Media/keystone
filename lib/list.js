...
module.exports = function (keystone) {
	...
	function List (key, options) {
		...
		var defaultOptions = {
			...
			admin: false,
			canViewItem: function() { return true },
			visibilityFilter: function() { return  {} },
			canCreate: function() { return true },
			canViewIndex: function() { return true },
		...
		this.canViewItem = this.options.canViewItem
		this.saveCallbackUrl = this.options.saveCallbackUrl;
		this.deleteCallbackUrl = this.options.deleteCallbackUrl;
		this.visibilityFilter = this.options.visibilityFilter;
		this.canCreate = this.options.canCreate;
		this.canViewIndex = this.options.canViewIndex;
		this.canEditItem = this.options.canEditItem || this.options.canViewItem;
		this.restrictedProperties = this.options.restrictedProperties;
		this.mappings = {
			name: null,
			createdBy: null,
			createdOn: null,
